...
export const GrepTool = Tool.define("grep", async (initCtx) => {
  ...
  if (isToolAllowed("ripgrep")) {
    description +=
      "\n- If you need to identify/count the number of matches within files, use the `ripgrep` tool directly. Do NOT use `grep`."
  }
